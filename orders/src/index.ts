...
const start =async ()=>{
    ...
    //we want to check right away of our required env variables are not defined instead of waiting for some request to throw an error
    //somewhere during the runtime.
